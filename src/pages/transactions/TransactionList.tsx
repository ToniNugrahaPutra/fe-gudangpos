            ...
            <section className="flex flex-col gap-5 flex-1 p-5 px-0">
              ...
              >
                ...
                {transactions.length > 0 ? (
                  transactions.map((tx) => (
                    <div className="card-merchant flex flex-col rounded-2xl border border-border">
                                      ...
                                      <tr key={tp.id} className="h-[90px]">
                                        ...
                                        <td className="px-3 py-2 text-right">
                                          <button
                                            ...
                                            className="text-white bg-primary px-4 py-1.5 rounded-full font-semibold"
                                          >
                                            Details
                                          </button>
                                        </td>
                      ...
                      <div className="flex items-center justify-start px-4 py-5">
                        ...
                        <p className="font-semibold text-lg text-monday-blue pl-2">
                  ...
                  <div
                    id="Empty-State"
                    className="hidden flex flex-col flex-1 items-center justify-center rounded-[20px] border-dashed border-2 border-border gap-5"
                  >
                    <img
